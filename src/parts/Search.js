...
export default function Search() {
  return (
    <div className="bg-[#222831] min-h-screen">
      <div className="text-white text-5xl flex items-center justify-center"></div>

      <form className="container mx-auto flex flex-col items-center justify-center h-screen">
        <img className="mb-10" src="/galonsearchlogo.png" alt="" />
